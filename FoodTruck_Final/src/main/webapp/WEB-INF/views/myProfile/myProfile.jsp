...
<!--                                           </div> -->
                                          ...
                                          <div class="form-group col-sm-6">
                                            ...
                                            <c:choose>
												<c:when test="${sessionScope.userChk == 1}">
                                       					<button id="business" onclick="click_business()" class="btn btn-primary mr-2" style="margin-left:330px; width:100px">업체등록</button>
                                       			</c:when>
                                       		</c:choose>
                                       		</div>	
                                       <br>

...
.form-control-date .form-control-loca {
	margin-left: 5px;
}
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div
							...
							<form action="UpdateSave.do" Method="get">
									...
									<div class="blog-description mt-3">
										<h5 class="mb-3 pb-3 border-bottom">
											<input type="text" class="form-control"
												id="exampleInputText1" name="requestTitle" placeholder="제목">
										</h5>
										<div
											class="blog-meta d-flex align-items-center mb-3 form-group">
											<div class="form-control-date form-group2 form-group">
												일정 : <input type="date" class="form-control2"
													name="requestDate" value="YYYY-MM-DD">
											</div>
											<div class="form-control-loca form-group2 form-group">
												장소 : <input type="text" class="form-control2"
													name="requestLocation" placeholder="푸드트럭 존 위치">
											</div>
										</div>
										<textarea class="form-control lineHeight"
											id="exampleFormControlTextarea1" name="requestContent"
											rows="5"></textarea>
										<div style="margin: 10px 10px -15px 410px;">
											<input type="hidden" name="requestSeq" value="${requestSeq }">
											<input type="submit" class="btn btn-primary"
												style="margin-left: 10px;" value="수정완료"> <input
												type="button" class="btn btn-primary"
												onclick="location.href='GetArticle.do?requestSeq=${requestSeq}';"
												style="margin-left: 10px;" value="수정취소">
										</div>
									</div>
								</div>
							</form>
										...
										<div class="d-flex align-items-top pb-3 border-bottom">
											...
											<div class="col-md-7">
												<div class="blog-description pl-2">
													<div class="date mb-1">
														<a href="#" tabindex="-1">4 주 전</a>
													</div>
													<h6 class="mb-2">게시글 제목 (이전 페이지의 제목 그대로)</h6>
												</div>
											</div>
										</div>
									</li>

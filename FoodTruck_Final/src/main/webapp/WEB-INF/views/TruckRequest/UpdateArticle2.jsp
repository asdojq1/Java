				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div
							...
							<form action="UpdateSave2.do" Method="get">
									...
									<div class="blog-description mt-3">
										<h5 class="mb-3 pb-3 border-bottom">
											<input type="text" class="form-control"
												id="exampleInputText1" name="recruitTitle" placeholder="제목">
										</h5>
										<div
										...
										<div style="margin: 10px 10px -15px 410px;">
											<input type="hidden" name="recruitSeq" value="${recruitSeq }">
											<input type="submit" class="btn btn-primary"
												style="margin-left: 10px;" value="수정완료"> <input
												type="button" class="btn btn-primary"
												onclick="location.href='GetArticle2.do?recruitSeq=${recruitSeq}';"

				...
				<div class="row">
					<div class="col-sm-12">
						<div class="iq-card position-relative inner-page-bg"
							style="height: 200px;">
							<img src="../resources/static/images/requestBg.png"
								class="img-fluid w-100" alt="header-bg"
								style="opacity: 0.5; height: 100%;">
							<div class="inner-page-title" style="color: black;">
								<h3>
									<strong>푸드트럭 요청</strong>
								</h3>
								<p>
									<strong><br>푸드트럭 찾아가기?? NO!!<br>우리동네로 부르자!!</strong>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="container-fluid" style="margin-top: 0px;">
										...
										<div class="d-flex align-items-top pb-3 border-bottom">
											...
											<div class="col-md-7">
												<div class="blog-description pl-2">
													...
													<h6 class="mb-2">(예시)반포자이 아파트 5일장 푸드트럭</h6>
												</div>
											</div>
										</div>
									</li>
										...
										<div class="d-flex align-items-top pb-3 border-bottom">
											...
											<div class="col-md-7">
												<div class="blog-description pl-2">
													...
													<h6 class="mb-2">(예시)광교 중흥S클라스 아파트 푸드트럭</h6>
												</div>
											</div>
										</div>
									</li>
					...
					<div class="row">
						<c:forEach items="${requestList }" var="request">
							<div class="col-sm-6">
								<div class="card iq-mb-3">
									<div class="card-body">
										<h4 class="card-title">${request.requestTitle }</h4>
										<p>
											일정 : ${request.requestDate }<br> 장소 :
											${request.requestLocation }<br> 작성자 :
											${sessionScope.userNick}
										</p>
										<p class="card-text">${request.requestContent }</p>
										<a href="GetArticle.do?requestSeq=${request.requestSeq }"
						...
						<div class="col-sm-6">
							<div class="card iq-mb-3">
								<div class="card-body">
									<h4 class="card-title">(예시)광교 중흥S클라스 아파트에 와주세요!!</h4>
									<p>
										일정 : 2021-10-15<br> 장소 : 광교 중흥S클라스 아파트 <br> 작성자 :
										광교맘카페<br>
										<br>수원 광교에 위치한 명품 아파트!! 주민화합행사에 많은 푸드트럭 업주님들을 초대합니다. 오셔서
										맛있는 음식과 즐거운 추억 만들어주시면 감사드리겠습니다.
									</p>
									<p class="card-text">${request.requestContent }</p>

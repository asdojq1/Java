						...
						<div
							...
							<div class="iq-card-body">
								...
								<div class="blog-description mt-3">
									<h5 class="mb-3 pb-3 border-bottom">${request.requestTitle }</h5>
									<div class="blog-meta d-flex align-items-center mb-3 floatLeft">
										<div class="date mr-4">
											<i class="ri-calendar-2-fill text-primary pr-2"></i>${request.requestDate }
										</div>
										<div class="like mr-4">
										...
										<div style="float: right">
											...
											<button class="btn btn-primary"
												onclick="location.href='UpdateArticle.do?requestSeq=${request.requestSeq}';"
												style="margin-left: 10px;">글 수정</button>
											<button class="btn btn-primary"
												onclick="location.href='deleteArticle.do?requestSeq=${request.requestSeq}';"
												style="margin-left: 10px;">글 삭제</button>
										</div>
									</div>
									<div style="float: left;">
										<p>
											일정 : ${request.requestDate } | 장소 : ${request.requestLocation }<br>작성자
											: ${sessionScope.userNick}<br> <br>${request.requestContent }
										</p>
									</div>
								</div>
							</div>
										...
										<div class="d-flex align-items-top pb-3 border-bottom">
											...
											<div class="col-md-7">
												<div class="blog-description pl-2">
													...
													<h6 class="mb-2">(예시)수원KT 위즈파크 푸드트럭와주세요!!</h6>
												</div>
											</div>
										</div>
									</li>
										...
										<div class="d-flex align-items-top pb-3 border-bottom">
											...
											<div class="col-md-7">
												<div class="blog-description pl-2">
													...
													<h6 class="mb-2">(예시)수원시청 앞 광장 푸드트럭 컴온!!</h6>
												</div>
											</div>
										</div>
									</li>
													...
													<div class="blog-description">
														...
														<div class="like mr-4">
															...
															<button class="btn iq-bg-danger"
																onclick="location.href='deleteComment.do?requestSeq=${request.requestSeq }&commentSeq=${comment.commentSeq}';">댓글
																삭제</button>
														</div>
													</div>
												</div>

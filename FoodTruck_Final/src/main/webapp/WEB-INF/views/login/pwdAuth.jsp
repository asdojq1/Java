                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 bg-white pt-5">
                        <div class="sign-in-from">
                            ...
                            <p>인증번호를 입력하세요</p>
                            <form method="get" action="pwdSearch.do">
                            	<% 
                            	String userId = request.getParameter("userId");
                            	String userEmail = request.getParameter("userEmail");
                            	%>

                            	<input type="hidden" name ="comCode" value="${num }">
                            	<input type="hidden" name ="userId" value="<%=userId%>">
                            	<input type="hidden" name ="userEmail" value="<%=userEmail%>">
                            	
                                <div class="form-group">
                                    <label for="exampleInputEmail1">인증번호</label>
                                    <input type="text" class="form-control mb-0" name="userCode" id="exampleInputEmail1" placeholder="Enter Id">
                                </div>

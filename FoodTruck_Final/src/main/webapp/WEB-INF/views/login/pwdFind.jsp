                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 bg-white pt-5">
                        <div class="sign-in-from">
                            ...
                            <p>찾을 비밀번호의 아이디와 이메일을 입력하세요</p>
                            <form method="post" action="pwdAuth.do">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">아이디</label>
                                    <input type="text" class="form-control mb-0" name="userId" id="exampleInputEmail1" placeholder="Enter Id">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">이메일</label>
                                   
                                    <input type="email" class="form-control mb-0" name="userEmail" id="exampleInputPassword1" placeholder="Enter email ">
                                </div>
                                ...
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">이미 계정이 있습니다.   <a href="signIn.do">로그인</a></span>

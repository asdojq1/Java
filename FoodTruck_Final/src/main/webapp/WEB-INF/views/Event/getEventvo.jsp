...
<html lang="en">
   <head>
     <style>
      ...
      <title>FT Zone | 이벤트 게시판 수정</title>
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title">이벤트 공간 글수정 </h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="UpdateEvent.do" method='get' enctype="multipart/form-data">
                                       <input type="hidden" value="${sessionScope.userId}">
                                       <input type="hidden" name="userId" value="123"> <!--  여기 밸류값 수정   -->
                                    
                                       <div class="form-group">
                                          <label for="cno">제목</label>
                                          <input type="text" class="form-control" id="cno" name="eventTitle" value="${Event.eventTitle }">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                           <input type="text" class="form-control" id="cno" name="eventContent" value="${Event.eventContent }"><br>
                                           <label for="email">월</label>
	                                       <input type="text" class="form-control" id="email" name="eventmm" value="${Event.eventmm }" ></input><br>
	                                       <label for="email">일</label>
	                                       <input type="text" class="form-control" id="email" name="eventdd" value="${Event.eventdd }" ></input><br>
<!-- 	                                       <label for="email">사진첨부</label> -->
<!--                                 		   <input type="file" maxlength="60" size="40" name='eventfile'> -->
	                                       
                                          
                                       </div>
                                       <input type="hidden" value="<%=eventseq %>" name="eventseq">
                                       <button type="submit" class="btn btn-primary mr-2" >글 수정하기</button>
                                       <button type="reset" class="btn iq-bg-danger" onclick="location.href='profile-event.do'">취소</button>
                                    </form>
                                 </div>
                              </div>
                           </div>

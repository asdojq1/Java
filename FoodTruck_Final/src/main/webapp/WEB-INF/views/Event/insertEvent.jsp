                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title">이벤트 공간 글추가 </h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="insertEv.do" method='post' enctype="multipart/form-data">
                                       <input type="hidden" value="${sessionScope.userId}">
                                       <input type="hidden" name="userId" value="123"> <!--  여기 밸류값 수정   -->
                                    
                                       <div class="form-group">
                                          <label for="cno">제목</label>
                                          <input type="text" class="form-control" id="cno" placeholder="적당히" name="eventTitle">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                           <input type="text" class="form-control" id="cno" placeholder="간략히" name="eventContent"><br>
                                           <label for="email">월</label>
	                                       <input type="text" class="form-control" id="email" name="eventmm" placeholder="예) 11월  > 11" ></input><br>
	                                       <label for="email">일</label>
	                                       <input type="text" class="form-control" id="email" name="eventdd" placeholder="예) 22일  > 22" ></input><br>

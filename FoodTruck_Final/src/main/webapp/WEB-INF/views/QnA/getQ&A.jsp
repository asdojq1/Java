...
<html lang="en">
   <head>
     <style>
      ...
      <title>FT Zone | Q&A 게시판 글 수정</title>
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title">Q&A 게시판 질문수정</h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="updateQnA.do" method='post'>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="cno"  name="qnaTitle" value="${member.qnaTitle}">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                          <textarea class="form-control"  rows="8" cols="50" name="qnaContent" >${member.qnaContent}</textarea>

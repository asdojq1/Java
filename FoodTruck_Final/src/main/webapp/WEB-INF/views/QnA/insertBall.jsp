...
<html lang="en">
   <head>
     <style>
      ...
      <title>FT Zone | 공공기관 게시판 글쓰기</title>
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title">공공기관 협업신청 </h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="insertB.do" method='post'>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="cno" placeholder="기관명 (지역 or 세부명)" name="ballTitle">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                          <textarea class="form-control"  rows="8" cols="50" placeholder="내용을 입력해주세요        ( 필수 : 1.푸드트럭 협업할 날자 , 2.푸드트럭존 자리(트럭@@대가능합니다.) )" name="ballContent" ></textarea>

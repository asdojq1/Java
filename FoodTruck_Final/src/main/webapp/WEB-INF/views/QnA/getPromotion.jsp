...
%>
<%
	String promotionseq = request.getParameter("promotionseq"); 
%>
...
<html lang="en">
   <head>
     <style>
      ...
      <title>FT Zone | 홍보 협찬 게시판 글 수정</title>
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title">홍보 협찬 요청 신청 게시판 질문수정</h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="updatePromotion.do" method='post'>
                                       <input type="hidden" name="userId" value="${sessionScope.userId}"> <!--  여기 밸류값 수정 완료  -->
                                	    <input type="hidden" name="promotionseq" value="<%=promotionseq%>"> <!--  여기 밸류값 수정  완료 -->
                                       <div class="form-group">
                                          <label for="cno">제목</label>
                                          <input type="text" class="form-control" id="cno"  name="promotionTitle" value="${member.promotionTitle}">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                          <textarea class="form-control"  rows="8" cols="50" name="promotionContent" >${member.promotionContent}</textarea>

...
<html lang="en">
   <head>
     <style>
      ...
      <title>FT Zone | 공공기관 게시판 글 수정</title>
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       <h4 class="card-title"> 공공기관 협업 신청 게시판 질문수정</h4>
                                    </div>
                                 </div>
                                  <div class="iq-card-body">
                                    <form action="updateBall.do" method='post'>
                                       <input type="hidden" name="userId" value="${sessionScope.userId}">
                                	    <input type="hidden" name="ballSeq" value="<%=ballseq%>"> 
                                       <div class="form-group">
                                          <label for="cno">제목</label>
                                          <input type="text" class="form-control" id="cno"  name="ballTitle" value="${member.ballTitle}">
                                       </div>
                                       <div class="form-group">
                                          <label for="email">내용</label>
                                          <textarea class="form-control"  rows="8" cols="50" name="ballContent" >${member.ballContent}</textarea>
                                       </div>
                                       <button type="submit" class="btn btn-primary mr-2" >글 남기기</button>
                                       <button type="reset" class="btn iq-bg-danger" onclick="location.href='pages-faqBall.do'">취소</button>
                                    </form>
                                 </div>
                              </div>
                           </div>
